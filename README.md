...
| `classNames`             | `{ container?: string; input?: string; "resend-button-container"?: string; "resend-button"?: string; "input-seperators"}` | Optional CSS class names for customizing component styles. | N/A                                                          |
